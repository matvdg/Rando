...
struct CustomPathView: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .center, spacing: 32) {
            ...
            RandomPathPreview(color: trail.colorHandlingLightAndDarkMode, lineWidth: trail.lineWidth).padding(.top).padding(.top)
            Label("Thickness", systemImage: "paintbrush")
        ...
        .navigationBarTitle(Text("CustomPath"))
    }
}
